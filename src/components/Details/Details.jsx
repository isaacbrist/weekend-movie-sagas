                ...
                <Grid item xs="auto">
                    <Card className={classes.detailSize}>
                        <Paper className={classes.detailSize}>
                            ...
                            <Typography> <img src={details.poster} alt={details.title}/></Typography>
                            <CardContent>
                                <Typography gutterBottom variant="body2" >{details.description} </Typography>
                            ...
                            <Button size="large" color='primary' variant="contained" onClick={handleClick}>Return to List</Button>
                        </Paper>
                    </Card>  
                </Grid>     
            </Grid>
