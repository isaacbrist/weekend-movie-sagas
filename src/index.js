...
try{
    ...
    console.log('In fetchDetails, this is detailsResponse.data', detailsResponse.data)
    yield put({type: 'SEND_DETAILS', payload: detailsResponse.data}) //might need [0] after  data
} catch(error) {
